...
const register = async (req, res) => {
  try {
    const { name, email, password, phone, role, lat, lng, address, orgName, registrationNumber } = req.body;
...
const updateMe = async (req, res) => {
  try {
    ...
    if (user.role === "ngo") {
      ...
      if (registrationNumber !== undefined) user.ngoDetails.registrationNumber = registrationNumber;
    }
